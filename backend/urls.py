...
from .api import CategoryAPIAdmin, CategoryAPIPublic, ProductAPIAdmin, ProductAPIPublic, ReviewAPIAuth, ReviewAPIPublic, ShoppingCartItemAPIAuth, WishlistItemAPIAuth
...
router.register('api/auth/wishlist',WishlistItemAPIAuth,'wishlist'),
